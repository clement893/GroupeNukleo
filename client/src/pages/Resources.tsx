        ...
        <section style={{ padding: '0 0 4rem' }}>
          <div className="container">
            <div style={{ marginBottom: '2rem' }}>
              <span style={{ fontFamily: "'Neue Haas Unica Pro', sans-serif", fontSize: '0.75rem', fontWeight: 600, letterSpacing: '0.12em', textTransform: 'uppercase', color: '#6b7280' }}>
              ...
              <p style={{ fontFamily: "'Neue Haas Unica Pro', sans-serif", fontSize: '1rem', color: '#6b7280', margin: 0, maxWidth: 560 }}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 w-full">
              {tools.map((tool, index) => (
                ...
                >
                  ...
                  <h3 style={{ fontFamily: "'Neue Haas Unica Pro', sans-serif", fontWeight: 700, fontSize: '1.35rem', color: '#111827', margin: '0 0 0.5rem 0' }}>
                    {tool.title}
                  </h3>
        ...
        <section style={{ padding: '0 0 1.5rem' }}>
          <div className="container">
            <div className="flex flex-wrap items-center gap-2">
              <div className="flex items-center gap-2 text-gray-700" style={{ fontFamily: "'Neue Haas Unica Pro', sans-serif" }}>
                  ...
                  <Link key={resource.id} href={getLocalizedPath(`/resources/${resource.id}`)}>
                    ...
                    >
                      <div style={{ padding: '1.5rem 1.75rem' }}>
                        ...
                        <h3 className="text-xl font-bold text-gray-900 group-hover:text-[#5A1E29] transition-colors mb-2" style={{ fontFamily: "'Neue Haas Unica Pro', sans-serif" }}>
                          {resource.title}
                        </h3>
                        <p className="text-sm text-gray-600 leading-relaxed mb-4" style={{ fontFamily: "'Neue Haas Unica Pro', sans-serif" }}>
        ...
        <section style={{ padding: '4rem 0 5rem' }}>
          <div className="container">
            <div className="w-full text-center">
              ...
              />
              <p style={{ fontFamily: "'Neue Haas Unica Pro', sans-serif", fontSize: '1rem', color: '#6b7280', lineHeight: 1.5, marginBottom: '1.5rem' }}>
              ...
              {isSubmitted && (
                <div style={{ marginBottom: '1rem', padding: '0.75rem 1rem', background: 'rgba(34,197,94,0.12)', border: '1px solid rgba(34,197,94,0.3)', borderRadius: 12 }}>
                  <p style={{ color: '#15803d', fontWeight: 500, fontFamily: "'Neue Haas Unica Pro', sans-serif" }}>{t('resources.newsletter.success')}</p>
                </div>
              )}
              {errorMessage && (
                <div style={{ marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: 8, padding: '0.75rem 1rem', background: 'rgba(239,68,68,0.08)', border: '1px solid rgba(239,68,68,0.2)', borderRadius: 12 }}>
                  ...
                  <p style={{ color: '#b91c1c', fontWeight: 500, fontFamily: "'Neue Haas Unica Pro', sans-serif", margin: 0 }}>{errorMessage}</p>
                </div>
              )}
              <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto" aria-label={t('resources.newsletter.title') || 'Newsletter'}>
                ...
                <button
                  ...
                  style={{ background: HERO_GRADIENT, fontFamily: "'Neue Haas Unica Pro', sans-serif" }}
                >
