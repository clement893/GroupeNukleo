...
export default function Contact() {
  ...
  return (
    <PageLayout>
      ...
      <div className="min-h-screen" style={{ background: 'transparent', fontFamily: "'Neue Haas Unica Pro', sans-serif", paddingTop: 'clamp(5rem, 15vw, 8rem)' }}>
          ...
          <div className="w-full">
            ...
            >
              ...
              <div className="glass-panel w-full rounded-md p-6 lg:p-8">
                <h2 className="text-2xl lg:text-3xl font-bold mb-4" style={{ color: BORDEAUX, fontFamily: "'Neue Haas Unica Pro', sans-serif" }}>
...
className="w-full px-4 py-2 rounded-md border border-gray-200 bg-white text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#523DCB]/30 focus:border-[#523DCB]"
            ...
            <div className="mt-12 lg:mt-16">
              <h2 className="text-xl lg:text-2xl font-bold mb-6" style={{ color: BORDEAUX, fontFamily: "'Neue Haas Unica Pro', sans-serif" }}>
                {t('contact.whereToFindUs')}
              </h2>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
                {/* Carte Montréal */}
                <div>
                  <p className="font-semibold mb-3" style={{ fontFamily: "'Neue Haas Unica Pro', sans-serif", color: SITE_BLACK }}>{t('contact.montreal')}</p>
                  <div
                ...
                {/* Carte Halifax */}
                <div>
                  <p className="font-semibold mb-3" style={{ fontFamily: "'Neue Haas Unica Pro', sans-serif", color: SITE_BLACK }}>{t('contact.halifax')}</p>
                  <div
                    className="rounded-md overflow-hidden bg-gray-100 shadow-sm border border-gray-200/60"
                    style={{ borderRadius: 7, minHeight: 420 }}
                  >
