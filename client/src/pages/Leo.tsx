...
export default function Leo() {
  ...
  return (
    <PageLayout>
      ...
      />
      <div className="min-h-screen flex flex-col" style={{ background: 'transparent', fontFamily: "'Neue Haas Unica Pro', sans-serif" }}>
      {/* Toolbar */}
        ...
        <div className="max-w-3xl mx-auto space-y-8 py-4 pb-6">
              ...
              {message.isEmailForm ? (
                ...
                >
                  ...
                  <div className={`flex flex-col ${message.role === 'user' ? 'items-end' : 'items-start'} max-w-full sm:max-w-[70%]`}>
                    ...
                    >
                      <p className="text-base leading-relaxed whitespace-pre-wrap" style={{ fontFamily: "'Neue Haas Unica Pro', sans-serif" }}>{message.content}</p>
                    </div>
                    <span className="text-xs text-gray-400 mt-2" style={{ fontFamily: "'Neue Haas Unica Pro', sans-serif" }}>
            ...
            <div className="flex gap-4 justify-start">
              ...
              <div className="flex flex-col items-start max-w-full sm:max-w-[70%]">
                ...
                <div className="px-6 py-4 rounded-2xl bg-white border border-gray-200 shadow-sm text-gray-900">
                  <p className="text-base leading-relaxed whitespace-pre-wrap" style={{ fontFamily: "'Neue Haas Unica Pro', sans-serif" }}>
                    {typingText}
          ...
          {showSuggestions && messages.length <= 3 && (
            <div className="mt-8 space-y-4">
              <p className="text-sm text-gray-500 text-center font-medium" style={{ fontFamily: "'Neue Haas Unica Pro', sans-serif" }}>{t('leo.suggestionsPrompt')}</p>
          ...
          <div className="container">
            <div className="max-w-3xl mx-auto">
              <div className="flex gap-3 items-center bg-white border border-gray-200 rounded-full px-5 py-2.5 shadow-sm">
                {showEmailForm ? (
                  <p className="flex-1 text-sm text-gray-500 py-2 px-1" style={{ fontFamily: "'Neue Haas Unica Pro', sans-serif" }}>
              ...
              <div className="flex items-center justify-between mt-3 text-xs text-gray-500" style={{ fontFamily: "'Neue Haas Unica Pro', sans-serif" }}>
