      ...
      <div className="min-h-screen" style={{ background: 'transparent' }}>
        ...
        <section style={{ padding: 'clamp(5rem, 10vh, 7rem) 0 2rem' }}>
          <div className="container">
            <Link href={getLocalizedPath('/resources')} className="inline-flex items-center gap-2 text-gray-600 hover:text-gray-900 mb-8 transition-colors group" style={{ fontFamily: "'Neue Haas Unica Pro', sans-serif", fontSize: '0.9rem', fontWeight: 500 }}>
            ...
            <div className="flex items-center gap-3 text-gray-500 text-sm" style={{ fontFamily: "'Neue Haas Unica Pro', sans-serif" }}>
            ...
            <div className="w-full">
              ...
              >
                <div className="mb-8 pb-8 border-b border-gray-200">
                  <p className="text-lg text-gray-700 leading-relaxed m-0" style={{ fontFamily: "'Neue Haas Unica Pro', sans-serif" }}>
                    {description}
                  </p>
                </div>
                ...
                <div className="mt-12 pt-8 border-t border-gray-200">
                  <h2 className="text-xl font-bold text-gray-900 mb-4" style={{ fontFamily: "'Neue Haas Unica Pro', sans-serif" }}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {Object.entries(articleMap)
                      ...
                      .map(([id, key]) => {
                        ...
                        return relatedTitle ? (
                          <Link key={id} href={getLocalizedPath(`/resources/${id}`)} className="block p-4 rounded-xl border border-gray-200 bg-gray-50/50 hover:bg-gray-50 hover:border-gray-300 transition-all" style={{ fontFamily: "'Neue Haas Unica Pro', sans-serif" }}>
