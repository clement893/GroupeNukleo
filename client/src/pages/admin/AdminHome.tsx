          ...
          <div className="flex items-start justify-between gap-3">
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                <CardTitle className="text-base font-semibold text-gray-900 group-hover:text-gray-900 transition-colors" style={{ fontFamily: "'Google Sans Flex', sans-serif" }}>
                  {title}
                </CardTitle>
                <CardDescription className="mt-0.5 text-sm text-gray-600 line-clamp-2" style={{ fontFamily: "'Google Sans Flex', sans-serif" }}>
                  {description}
                </CardDescription>
              </div>
            </div>
    ...
    <AdminLayout>
      <div className="p-6 lg:p-8 max-w-5xl">
        <header className="mb-8">
          <h1 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl" style={{ fontFamily: "'Google Sans Flex', sans-serif" }}>
            Administration
          </h1>
          <p className="mt-1 text-gray-600" style={{ fontFamily: "'Google Sans Flex', sans-serif" }}>
        ...
        <section className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          <Card className="border border-gray-200 bg-white shadow-sm">
            <CardHeader className="pb-2">
              <CardDescription className="text-xs font-medium uppercase tracking-wider text-gray-500" style={{ fontFamily: "'Google Sans Flex', sans-serif" }}>
                Pages admin
              </CardDescription>
              <CardTitle className="text-2xl font-bold text-gray-900" style={{ fontFamily: "'Google Sans Flex', sans-serif" }}>{totalSections}</CardTitle>
            </CardHeader>
          </Card>
          <Card className="border border-gray-200 bg-white shadow-sm">
            <CardHeader className="pb-2">
              ...
              <CardTitle className="text-2xl font-bold flex items-center gap-2 text-gray-900" style={{ fontFamily: "'Google Sans Flex', sans-serif" }}>
          ...
          <Card className="border border-gray-200 bg-white shadow-sm">
            <CardHeader className="pb-2">
              ...
              <CardTitle className="text-2xl font-bold text-gray-900" style={{ fontFamily: "'Google Sans Flex', sans-serif" }}>{ADMIN_CATEGORIES.length}</CardTitle>
            </CardHeader>
          </Card>
          <Card className="border border-gray-200 bg-white shadow-sm">
            <CardHeader className="pb-2">
              ...
              <CardTitle className="text-lg font-bold text-gray-900" style={{ fontFamily: "'Google Sans Flex', sans-serif" }}>Aujourd'hui</CardTitle>
            </CardHeader>
          </Card>
        </section>
        ...
        <div className="space-y-8">
          {ADMIN_CATEGORIES.map((category, idx) => (
            <section key={idx}>
              <div className="mb-3">
                <h2 className="text-sm font-semibold uppercase tracking-wider text-gray-600" style={{ fontFamily: "'Google Sans Flex', sans-serif" }}>
                  {category.title}
                </h2>
                <p className="text-gray-500 mt-0.5" style={{ fontFamily: "'Google Sans Flex', sans-serif" }}>{category.description}</p>
              </div>
        ...
        <footer className="mt-10 p-4 rounded-xl bg-white border border-gray-200 shadow-sm">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-semibold text-gray-900" style={{ fontFamily: "'Google Sans Flex', sans-serif" }}>Besoin d'aide ?</h3>
              <p className="text-sm text-gray-600 mt-1" style={{ fontFamily: "'Google Sans Flex', sans-serif" }}>
