    ...
    if (isChunkError) {
      ...
      if (attempts >= MAX_RELOAD_ATTEMPTS) {
        ...
        document.body.innerHTML = `
          <div style="display: flex; align-items: center; justify-content: center; min-height: 100vh; padding: 20px; text-align: center; font-family: 'Neue Haas Unica Pro', sans-serif;">
            <div>
