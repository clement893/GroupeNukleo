...
export const PROJECTS_DATA: ProjectData[] = [
  ...
  },
  {
    ...
    year: '2025',
    category: 'Plateforme',
    services: 'Nukleo.Tech, Nukleo.Studio, Développement mobile, Réalité augmentée, Design UX/UI, Narration audio',
    websiteUrl: 'https://adelplay.com',
    description: {
      fr: "Adèle Blais est une artiste peintre sherbrookoise dont les murales transforment les murs de la ville en œuvres vivantes. Elle nous a confié un défi ambitieux : créer une application mobile capable de donner une seconde vie à ses œuvres grâce à la réalité augmentée et à la narration audio. L'objectif était de permettre aux passants de pointer leur téléphone vers une murale et d'accéder à une expérience immersive — l'œuvre s'anime, l'artiste parle, l'art devient interactif.\n\nNukleo a mobilisé ses pôles Tech et Studio pour concevoir et développer une application cutting-edge, alliant ingénierie mobile avancée, design d'expérience et intégration audio. Le résultat : une application téléchargée des milliers de fois, saluée par la communauté artistique et numérique.\n\nL'impact a dépassé le projet initial : la Ville de Sherbrooke a adopté l'application dans le cadre de son grand projet de murales urbaines lancé en 2025, faisant d'AdelPlay un outil officiel de médiation culturelle à l'échelle de la ville.",
      en: "Adèle Blais is a Sherbrooke-based painter whose murals transform the city's walls into living works of art. She entrusted us with an ambitious challenge: create a mobile application that brings her works to life through augmented reality and audio narration. The goal was to allow passersby to point their phone at a mural and access an immersive experience — the artwork animates, the artist speaks, art becomes interactive.\n\nNukleo mobilized its Tech and Studio teams to design and develop a cutting-edge application combining advanced mobile engineering, experience design, and audio integration. The result: an app downloaded thousands of times, celebrated by both the artistic and digital communities.\n\nThe impact exceeded the original project: the City of Sherbrooke adopted the application as part of its major urban mural project launched in 2025, making AdelPlay an official cultural mediation tool across the city.",
    },
    images: [
      'AdeleBlais_1.png',
      'AdeleBlais_2.png',
